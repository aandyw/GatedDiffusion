...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlNetMixin):
    ...
    def __init__(
        ...
        self.conv_in = nn.Conv2d(output_channel, output_channel, kernel_size=conv_in_kernel, padding=conv_in_padding)
    ...
    def from_unet(
        ...
        if load_weights_from_unet:
            ...
            controlnet.up_blocks.load_state_dict(unet.down_blocks.state_dict())
    ...
    def forward(
        ...
        for upsample_block in self.up_blocks:
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                ...
                sample, res_samples = upsample_block(hidden_states=sample, temb=emb)
        ...
        if not return_dict:
            return up_block_res_samples

        return ControlNetOutput(up_block_res_samples=up_block_res_samples)
