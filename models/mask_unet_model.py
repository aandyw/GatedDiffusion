# modified from diffusers.models.unets.unet_2d_condition
...
class MaskUNetModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        self.mask_act_fn_out = self.__get_activation(mask_act_fn)
    ...
    def forward(
        ...
        r"""
        The [`MaskModelOutput`] forward method.
        ...
        Args:
            ...
            return_dict (`bool`, *optional*, defaults to `True`):
                Whether or not to return a [`MaskModelOutput`] instead of a plain
                tuple.
            cross_attention_kwargs (`dict`, *optional*):
        ...
        Returns:
            [`MaskModelOutput`] or `tuple`:
                If `return_dict` is True, an [`MaskModelOutput`] is returned, otherwise
        ...
        sample = torch.mean(sample, dim=1, keepdim=True)
        ...
        return MaskModelOutput(mask=mask)
