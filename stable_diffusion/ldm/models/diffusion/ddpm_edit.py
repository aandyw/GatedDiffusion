...
class DDPM(pl.LightningModule):
    ...
    def p_losses(self, x_start, t, noise=None):
        ...
        mask_model_out = self.mask_model(x_noisy, t)
        edit_img_embed = mask_model_out * model_out + (1 - mask_model_out) * x_start
        loss = self.get_loss(edit_img_embed, target, mean=False).mean(dim=[1, 2, 3])
